...
public class Shop {
	...
	private ShopCategory shopCategoryId;
    ...
    public PersonInfo getOwnerId() {
        return ownerId;
    }

    public void setOwnerId(PersonInfo ownerId) {
        this.ownerId = ownerId;
    }

    public ShopCategory getShopCategoryId() {
        return shopCategoryId;
    }

    public void setShopCategoryId(ShopCategory shopCategoryId) {
